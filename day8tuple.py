#tuple= sequence data type, collection of data
# immutable(origninal daata not changeable)
#data seperated by comma,
#fixed postion and in order
#allow duplicate value

#difference betweeen list and tuple
#imutable
#methods (donot have methods)
#performance(faster than list because list data can be update,add,change etc )
a = (12,34.5,"bipama")
print(type(a))
print(a) 
print(len(a))
...
# b = ("apple",45,67.8,"bipana",34)
# print(b[::]) #to print all
